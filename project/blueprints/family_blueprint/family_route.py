        ...
        return make_response(
            {
                ...
                "Members": [family.member.serialize for family.member in family.members]
            },200
        )
...
def create_family(current_member):
    ...
    if not name:
        return make_response(
            {
                "message": "Opps! Please provide family name"
            }
        )
    try:
        if current_member.family_id != None :
            return make_response(
                {
                    "message": "You already part of a family."
                }, 400
            )  
        ...
        return make_response(
            {
                "family": "Success family was created"
            }, 200
        )
    except Exception as e:
        return make_response(
            {
                "message": "Opps! Family wasn't created."
            }, 400
        )
...
def update_family(current_member):
    ...
    if not name :
        return make_response(
            {
                "message": "Opps! Please enter valid name "
            }, 400
        )
    ...
    try:
        ...
        return make_response(
            {
                "message": "Success family has been updated."
            }, 200
        )
    except Exception as e:
        return make_response(
            {
                "message": "Opps! Family didn't update. Try again. "
            },500
        )
...
def delete_family(current_member):
    try:
        ...
        return make_response(
            {
                "message": "Opps! Family didn't delete try again."
            }
        ), 500
        ...
        return make_response(
            {
                ...
                "member": "Success! member added to family."
            },200
        )
    except Exception as e :
        return make_response(
            {
                "message": "Unable to add member to family. please try again"
            },500
        )
